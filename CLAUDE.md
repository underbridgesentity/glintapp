...
4. **Three colours, no exceptions.** No secondary colours, no tints beyond the defined lemon-dim overlay. *Amendment (2026-07-09):* on marketing surfaces only, a subtle lemon-dim-to-transparent gradient is permitted as a card/surface treatment; the product app remains gradient-free.
5. **Electric Lemon is the accent.** In the product app: at most twice per screen, it signals action. *Amendment (2026-07-09):* the marketing site may use lemon more liberally as the brand accent (section labels, featured card, lemon CTA block) — deliberately, not decoratively scattered. White text on lemon remains forbidden everywhere.
